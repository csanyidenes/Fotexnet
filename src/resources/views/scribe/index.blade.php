...
<p>This API is not authenticated.</p>
    ...
    <p>API for managing movies.</p>

                                <h2 id="movies-GETapi-movies">Get all movies</h2>
...
<div class="bash-example">
    ...
    --get "http://localhost/api/movies?title=Inception" \
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="GETapi-movies"
               value="Inception"
               data-component="query">
    <br>
<p>Search by title. Example: <code>Inception</code></p>
            </div>
                </form>

                    <h2 id="movies-POSTapi-movies">Create a new movie</h2>
...
<code class="language-json" style="max-height: 300px;">{
    ...
    &quot;errors&quot;: {
        ...
        &quot;age_rating&quot;: [
            &quot;The age_rating field is required.&quot;
        ]
    }
}</code>
 </pre>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The title of the movie. Example: <code>Inception</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>age_rating</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="age_rating"                data-endpoint="POSTapi-movies"
               value="16"
               data-component="body">
    <br>
<p>The age rating of the movie. Example: <code>16</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="language"                data-endpoint="POSTapi-movies"
               value="English"
               data-component="body">
    <br>
<p>The language of the movie. Example: <code>English</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The cover image URL of the movie. Example: <code>https://example.com/inception.jpg</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
        <details>
            <summary style="padding-bottom: 10px;">
                <b style="line-height: 2;"><code>projections</code></b>&nbsp;&nbsp;
<small>object[]</small>&nbsp;
 &nbsp;
<br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="projections.0.start_time"                data-endpoint="POSTapi-movies"
               value="2025-03-21 21:07:08"
               data-component="body">
    <br>
<p>Must be a valid date in the format <code>Y-m-d H:i:s</code>. Example: <code>2025-03-21 21:07:08</code></p>
                    </div>
                                                                <div style="margin-left: 14px; clear: unset;">
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="projections.0.available_seats"                data-endpoint="POSTapi-movies"
               value="1"
               data-component="body">
    <br>
<p>Must be at least 0. Must not be greater than 300. Example: <code>1</code></p>
                    ...
                    <h2 id="movies-GETapi-movies--id-">Get a single movie</h2>

<p>
</p>

<p>Returns a single movie by ID.</p>
...
<p>The ID of the movie. Example: <code>1</code></p>
                    ...
                    <h2 id="movies-PUTapi-movies--id-">Update a movie</h2>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="PUTapi-movies--id-"
               value="Inception"
               data-component="body">
    <br>
<p>The title of the movie. Example: <code>Inception</code></p>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="age_rating"                data-endpoint="PUTapi-movies--id-"
               value="16"
               data-component="body">
    <br>
<p>The age rating of the movie. Example: <code>16</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="language"                data-endpoint="PUTapi-movies--id-"
               value="English"
               data-component="body">
    <br>
<p>The language of the movie. Example: <code>English</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="cover_image"                data-endpoint="PUTapi-movies--id-"
               value="https://example.com/inception.jpg"
               data-component="body">
    <br>
<p>The cover image URL of the movie. Example: <code>https://example.com/inception.jpg</code></p>
                    ...
                    <h2 id="movies-DELETEapi-movies--id-">Delete a movie</h2>

<p>
</p>

<p>Deletes a movie by ID.</p>
